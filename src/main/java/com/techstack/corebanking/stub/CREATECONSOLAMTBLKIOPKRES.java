 ...
 *                   &lt;element name="Cabm-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}ConsolAmtBlk-Create-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CREATECONSOLAMTBLK_IOPK_RES")
public class CREATECONSOLAMTBLKIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        protected ConsolAmtBlkCreateIOType cabmIO;
         ...
         * @return
         *     possible object is
         *     {@link ConsolAmtBlkCreateIOType }
         *     
         */
        public ConsolAmtBlkCreateIOType getCabmIO() {
            return cabmIO;
        }
         ...
         *     
         */
        public void setCabmIO(ConsolAmtBlkCreateIOType value) {
            this.cabmIO = value;
        }
