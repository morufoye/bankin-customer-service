 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Sttm-Cust-Fatca-PK" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}FATCA-PK-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Sttm-Cust-Fatca-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}FATCA-Delete-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "DELETEFATCA_IOPK_RES")
public class DELETEFATCAIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Sttm-Cust-Fatca-PK")
        protected FATCAPKType sttmCustFatcaPK;
        @XmlElement(name = "Sttm-Cust-Fatca-IO")
        protected FATCADeleteIOType sttmCustFatcaIO;
        ...
        /**
         * Gets the value of the sttmCustFatcaPK property.
         * 
         * @return
         *     possible object is
         *     {@link FATCAPKType }
         *     
         */
        public FATCAPKType getSttmCustFatcaPK() {
            return sttmCustFatcaPK;
        }

        /**
         * Sets the value of the sttmCustFatcaPK property.
         * 
         * @param value
         *     allowed object is
         *     {@link FATCAPKType }
         *     
         */
        public void setSttmCustFatcaPK(FATCAPKType value) {
            this.sttmCustFatcaPK = value;
        }

        /**
         * Gets the value of the sttmCustFatcaIO property.
         * 
         * @return
         *     possible object is
         *     {@link FATCADeleteIOType }
         *     
         */
        public FATCADeleteIOType getSttmCustFatcaIO() {
            return sttmCustFatcaIO;
        }

        /**
         * Sets the value of the sttmCustFatcaIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link FATCADeleteIOType }
         *     
         */
        public void setSttmCustFatcaIO(FATCADeleteIOType value) {
            this.sttmCustFatcaIO = value;
        }
