 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Sttm-Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}CustSignImge-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Sttm-Customer-Full" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}CustSignImge-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYCUSTSIGNIMGE_IOFS_RES")
public class QUERYCUSTSIGNIMGEIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Sttm-Customer-IO")
        protected CustSignImgeQueryIOType sttmCustomerIO;
        @XmlElement(name = "Sttm-Customer-Full")
        protected CustSignImgeFullType sttmCustomerFull;
        ...
        /**
         * Gets the value of the sttmCustomerIO property.
         * 
         * @return
         *     possible object is
         *     {@link CustSignImgeQueryIOType }
         *     
         */
        public CustSignImgeQueryIOType getSttmCustomerIO() {
            return sttmCustomerIO;
        }

        /**
         * Sets the value of the sttmCustomerIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link CustSignImgeQueryIOType }
         *     
         */
        public void setSttmCustomerIO(CustSignImgeQueryIOType value) {
            this.sttmCustomerIO = value;
        }

        /**
         * Gets the value of the sttmCustomerFull property.
         * 
         * @return
         *     possible object is
         *     {@link CustSignImgeFullType }
         *     
         */
        public CustSignImgeFullType getSttmCustomerFull() {
            return sttmCustomerFull;
        }

        /**
         * Sets the value of the sttmCustomerFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link CustSignImgeFullType }
         *     
         */
        public void setSttmCustomerFull(CustSignImgeFullType value) {
            this.sttmCustomerFull = value;
        }
