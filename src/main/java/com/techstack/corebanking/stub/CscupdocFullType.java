...
public class CscupdocFullType {
    ...
    protected List<DocUpload> docUpload;
    @XmlElement(name = "Ui-Columns")
    protected UiColumns uiColumns;
    ...
    public List<DocUpload> getDocUpload() {
        if (docUpload == null) {
            docUpload = new ArrayList<DocUpload>();
        }
     ...
     *     
     */
    public void setUiColumns(UiColumns value) {
