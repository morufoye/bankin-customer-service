 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Account-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}AccAmountBlock-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Account-Full" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}AccAmountBlock-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYBLK_IOFS_RES")
public class QUERYBLKIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Account-IO")
        protected AccAmountBlockQueryIOType accountIO;
        @XmlElement(name = "Account-Full")
        protected AccAmountBlockFullType accountFull;
        ...
        /**
         * Gets the value of the accountIO property.
         * 
         * @return
         *     possible object is
         *     {@link AccAmountBlockQueryIOType }
         *     
         */
        public AccAmountBlockQueryIOType getAccountIO() {
            return accountIO;
        }

        /**
         * Sets the value of the accountIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link AccAmountBlockQueryIOType }
         *     
         */
        public void setAccountIO(AccAmountBlockQueryIOType value) {
            this.accountIO = value;
        }

        /**
         * Gets the value of the accountFull property.
         * 
         * @return
         *     possible object is
         *     {@link AccAmountBlockFullType }
         *     
         */
        public AccAmountBlockFullType getAccountFull() {
            return accountFull;
        }

        /**
         * Sets the value of the accountFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link AccAmountBlockFullType }
         *     
         */
        public void setAccountFull(AccAmountBlockFullType value) {
            this.accountFull = value;
        }
