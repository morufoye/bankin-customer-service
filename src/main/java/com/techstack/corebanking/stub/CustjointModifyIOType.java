 ...
 *         &lt;element name="Custjoint" maxOccurs="unbounded"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
...
public class CustjointModifyIOType {
    ...
    @XmlElement(name = "Custjoint", required = true)
    protected List<Custjoint> custjoint;
     ...
     * 
     */
    public List<Custjoint> getCustjoint() {
        if (custjoint == null) {
            custjoint = new ArrayList<Custjoint>();
        }
