 ...
 *                   &lt;element name="Cabm-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}ConsolAmtBlk-Reopen-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "REOPENCONSOLAMTBLK_IOPK_RES")
public class REOPENCONSOLAMTBLKIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        protected ConsolAmtBlkReopenIOType cabmIO;
         ...
         * @return
         *     possible object is
         *     {@link ConsolAmtBlkReopenIOType }
         *     
         */
        public ConsolAmtBlkReopenIOType getCabmIO() {
            return cabmIO;
        }
         ...
         *     
         */
        public void setCabmIO(ConsolAmtBlkReopenIOType value) {
            this.cabmIO = value;
        }
