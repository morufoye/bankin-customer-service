 ...
 *                   &lt;element name="Main-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}CustomerObligation-Create-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CREATECUSTOMEROBLIGATION_IOPK_RES")
public class CREATECUSTOMEROBLIGATIONIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        protected CustomerObligationCreateIOType mainIO;
         ...
         * @return
         *     possible object is
         *     {@link CustomerObligationCreateIOType }
         *     
         */
        public CustomerObligationCreateIOType getMainIO() {
            return mainIO;
        }
         ...
         *     
         */
        public void setMainIO(CustomerObligationCreateIOType value) {
            this.mainIO = value;
        }
