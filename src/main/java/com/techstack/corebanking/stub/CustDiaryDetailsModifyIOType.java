 ...
 *         &lt;element name="Diary-Mst" maxOccurs="unbounded"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
...
public class CustDiaryDetailsModifyIOType {
    ...
    @XmlElement(name = "Diary-Mst", required = true)
    protected List<DiaryMst> diaryMst;
     ...
     * 
     */
    public List<DiaryMst> getDiaryMst() {
        if (diaryMst == null) {
            diaryMst = new ArrayList<DiaryMst>();
        }
