 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Cabm-PK" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}ConsolAmtBlk-PK-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Cabm-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}ConsolAmtBlk-Authorize-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "AUTHORIZECONSOLAMTBLK_IOPK_RES")
public class AUTHORIZECONSOLAMTBLKIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Cabm-PK")
        protected ConsolAmtBlkPKType cabmPK;
        @XmlElement(name = "Cabm-IO")
        protected ConsolAmtBlkAuthorizeIOType cabmIO;
        ...
        /**
         * Gets the value of the cabmPK property.
         * 
         * @return
         *     possible object is
         *     {@link ConsolAmtBlkPKType }
         *     
         */
        public ConsolAmtBlkPKType getCabmPK() {
            return cabmPK;
        }

        /**
         * Sets the value of the cabmPK property.
         * 
         * @param value
         *     allowed object is
         *     {@link ConsolAmtBlkPKType }
         *     
         */
        public void setCabmPK(ConsolAmtBlkPKType value) {
            this.cabmPK = value;
        }

        /**
         * Gets the value of the cabmIO property.
         * 
         * @return
         *     possible object is
         *     {@link ConsolAmtBlkAuthorizeIOType }
         *     
         */
        public ConsolAmtBlkAuthorizeIOType getCabmIO() {
            return cabmIO;
        }

        /**
         * Sets the value of the cabmIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link ConsolAmtBlkAuthorizeIOType }
         *     
         */
        public void setCabmIO(ConsolAmtBlkAuthorizeIOType value) {
            this.cabmIO = value;
        }
