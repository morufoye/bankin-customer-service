 ...
 *                   &lt;element name="Cabm-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}ConsolAmtBlk-Delete-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "DELETECONSOLAMTBLK_IOPK_RES")
public class DELETECONSOLAMTBLKIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        protected ConsolAmtBlkDeleteIOType cabmIO;
         ...
         * @return
         *     possible object is
         *     {@link ConsolAmtBlkDeleteIOType }
         *     
         */
        public ConsolAmtBlkDeleteIOType getCabmIO() {
            return cabmIO;
        }
         ...
         *     
         */
        public void setCabmIO(ConsolAmtBlkDeleteIOType value) {
            this.cabmIO = value;
        }
