 ...
 *                   &lt;element name="Cabm-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}ConsolAmtBlk-Close-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CLOSECONSOLAMTBLK_IOPK_RES")
public class CLOSECONSOLAMTBLKIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        protected ConsolAmtBlkCloseIOType cabmIO;
         ...
         * @return
         *     possible object is
         *     {@link ConsolAmtBlkCloseIOType }
         *     
         */
        public ConsolAmtBlkCloseIOType getCabmIO() {
            return cabmIO;
        }
         ...
         *     
         */
        public void setCabmIO(ConsolAmtBlkCloseIOType value) {
            this.cabmIO = value;
        }
