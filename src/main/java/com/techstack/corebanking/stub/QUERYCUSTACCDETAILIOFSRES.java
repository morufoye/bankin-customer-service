 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Sttms-Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}CustAccDetail-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Sttms-Customer-Full" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}CustAccDetail-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYCUSTACCDETAIL_IOFS_RES")
public class QUERYCUSTACCDETAILIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Sttms-Customer-IO")
        protected CustAccDetailQueryIOType sttmsCustomerIO;
        @XmlElement(name = "Sttms-Customer-Full")
        protected CustAccDetailFullType sttmsCustomerFull;
        ...
        /**
         * Gets the value of the sttmsCustomerIO property.
         * 
         * @return
         *     possible object is
         *     {@link CustAccDetailQueryIOType }
         *     
         */
        public CustAccDetailQueryIOType getSttmsCustomerIO() {
            return sttmsCustomerIO;
        }

        /**
         * Sets the value of the sttmsCustomerIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link CustAccDetailQueryIOType }
         *     
         */
        public void setSttmsCustomerIO(CustAccDetailQueryIOType value) {
            this.sttmsCustomerIO = value;
        }

        /**
         * Gets the value of the sttmsCustomerFull property.
         * 
         * @return
         *     possible object is
         *     {@link CustAccDetailFullType }
         *     
         */
        public CustAccDetailFullType getSttmsCustomerFull() {
            return sttmsCustomerFull;
        }

        /**
         * Sets the value of the sttmsCustomerFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link CustAccDetailFullType }
         *     
         */
        public void setSttmsCustomerFull(CustAccDetailFullType value) {
            this.sttmsCustomerFull = value;
        }
