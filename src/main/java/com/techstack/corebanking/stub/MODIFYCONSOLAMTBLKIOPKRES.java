 ...
 *                   &lt;element name="Cabm-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}ConsolAmtBlk-Modify-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "MODIFYCONSOLAMTBLK_IOPK_RES")
public class MODIFYCONSOLAMTBLKIOPKRES {
    ...
    public static class FCUBSBODY {
        ...
        protected ConsolAmtBlkModifyIOType cabmIO;
         ...
         * @return
         *     possible object is
         *     {@link ConsolAmtBlkModifyIOType }
         *     
         */
        public ConsolAmtBlkModifyIOType getCabmIO() {
            return cabmIO;
        }
         ...
         *     
         */
        public void setCabmIO(ConsolAmtBlkModifyIOType value) {
            this.cabmIO = value;
        }
