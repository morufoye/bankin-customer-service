 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Cabm-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}ConsolAmtBlk-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Cabm-Full" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}ConsolAmtBlk-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYCONSOLAMTBLK_IOFS_RES")
public class QUERYCONSOLAMTBLKIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        protected ConsolAmtBlkQueryIOType cabmIO;
        @XmlElement(name = "Cabm-Full")
        protected ConsolAmtBlkFullType cabmFull;
         ...
         * @return
         *     possible object is
         *     {@link ConsolAmtBlkQueryIOType }
         *     
         */
        public ConsolAmtBlkQueryIOType getCabmIO() {
            return cabmIO;
        }
         ...
         *     
         */
        public void setCabmIO(ConsolAmtBlkQueryIOType value) {
            this.cabmIO = value;
        }

        /**
         * Gets the value of the cabmFull property.
         * 
         * @return
         *     possible object is
         *     {@link ConsolAmtBlkFullType }
         *     
         */
        public ConsolAmtBlkFullType getCabmFull() {
            return cabmFull;
        }

        /**
         * Sets the value of the cabmFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link ConsolAmtBlkFullType }
         *     
         */
        public void setCabmFull(ConsolAmtBlkFullType value) {
            this.cabmFull = value;
        }
