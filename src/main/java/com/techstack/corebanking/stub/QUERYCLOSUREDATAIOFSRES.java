 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Cust-Closure-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}ClosureData-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Cust-Closure-Full" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}ClosureData-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYCLOSUREDATA_IOFS_RES")
public class QUERYCLOSUREDATAIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Cust-Closure-IO")
        protected ClosureDataQueryIOType custClosureIO;
        @XmlElement(name = "Cust-Closure-Full")
        protected ClosureDataFullType custClosureFull;
        ...
        /**
         * Gets the value of the custClosureIO property.
         * 
         * @return
         *     possible object is
         *     {@link ClosureDataQueryIOType }
         *     
         */
        public ClosureDataQueryIOType getCustClosureIO() {
            return custClosureIO;
        }

        /**
         * Sets the value of the custClosureIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link ClosureDataQueryIOType }
         *     
         */
        public void setCustClosureIO(ClosureDataQueryIOType value) {
            this.custClosureIO = value;
        }

        /**
         * Gets the value of the custClosureFull property.
         * 
         * @return
         *     possible object is
         *     {@link ClosureDataFullType }
         *     
         */
        public ClosureDataFullType getCustClosureFull() {
            return custClosureFull;
        }

        /**
         * Sets the value of the custClosureFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link ClosureDataFullType }
         *     
         */
        public void setCustClosureFull(ClosureDataFullType value) {
            this.custClosureFull = value;
        }
